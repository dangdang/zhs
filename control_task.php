...
$maxRows_Recordset1 = get_item( 'maxrows_task' );//查询后台配置，每页最大任务数量
...
$maxRows_timeout = get_item( 'maxrows_timeout' );//每页过期任务数
$pageNum_timeout = 0;
...
/*在session中存储用户选择：任务来自谁，该select 隐藏显示*/
...
/*在session中存储用户选择：任务创建人，该select 隐藏显示*/
...
<div class="panel panel-warning timeout_color pagemarginfix">
  ...
  <table  class="table  table-hover " style="border-bottom:1px #ddd solid;">
   ...
   [<?php echo $row_timeout['task_tpye']; ?>] <?php echo $row_timeout['csa_text']; ?> 
            ...
            <td class="gray">
                <?php 
	  $live_days =ceil((strtotime(date("Y-m-d")) - strtotime($row_timeout['csa_plan_et']))/86400);
...
<select class="form-control input-sm" name="select_year" id="select_year" ><!--年的选择-->
...
<select class="form-control input-sm"  name="textfield" id="textfield"> <!--月的选择-->
...
<select class="form-control input-sm" name="select_st" id="select_st"><!--项目状态的选择-->
...
?>
	  ...
	  <select class="form-control input-sm" name="select_type" id="select_type"><!--任务类型的选择-->
...
?>
	  ...
	  <select class="form-control input-sm" name="select_prt" id="select_prt"><!--任务优先级的选择-->
	  ...
	  <select class="form-control input-sm" name="select_project" id="select_project"><!--任务所属项目的选择-->
...
<table  border="0" cellspacing="0" cellpadding="0" align="center"  class="maintable tasktab_bl" >
 ...
 <thead  class="toptable tasktab_tl"> <!--任务表的表头-->
    <tr>
