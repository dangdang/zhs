...
<!--zhl:设置项目类型等相关属性-->
<span class="<?php if($pagename == "project_type_list.php"){echo "set_menu_onfocus";} else {echo "set_menu_nofocus";}?>"><a href="project_type_list.php"><?php echo $multilingual_projecttype_title; ?></a></span>
