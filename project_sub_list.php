...
<title>综合所 - <?php echo $multilingual_projectsub_title; ?></title> <!--TODO：zhl 修改wss-->
...
<div class="ui-state-highlight fontsize-s" style=" padding: 5px; width:100%;"> 
    ...
    <li class="feature01">
<span class="fontbold "><?php echo $multilingual_projectsub_title; ?></span><br />
<?php echo $multilingual_projectsub_text; ?>
</li>
    </div>
    </div>
</div>
