...
$multilingual_dd_role_pm = "项目负责人";//zhl:根据所里需求修改
...
$multilingual_foot_officialsite = "院网站";/*zhl修改*/
$multilingual_foot_officialsitetitle = "规划院官方网站";/*zhl修改*/
...
$multilingual_project_type = "项目类型"; /*zhl:项目类型*/
$multilingual_project_source = "任务来源"; /*zhl:项目来源*/
$multilingual_project_month_eval = "项目估计人月"; /*zhl:项目估计人月*/
$multilingual_project_start = "开始时间";
$multilingual_project_end = "结束时间";
$multilingual_project_touser = "负责人";
$multilingual_project_member = "项目成员";/*zhl:项目成员*/
...
$multilingual_personSelect_tips="请按顺序选择人员";
...
$multilingual_projecttype_title = "项目类型管理";
$multilingual_projecttype_new = "新建项目类型";//zhl
$multilingual_projecttype_name = "项目类型名称";//zhl
$multilingual_projecttype_edit = "编辑项目类型";//zhl
$multilingual_project_type_searchbtn = "按项目类型搜索";
$multilingual_project_searchbtn = "项目查询";//zhl
