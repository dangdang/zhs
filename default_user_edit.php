...
if ((isset ( $_POST ["MM_update"] )) && ($_POST ["MM_update"] == "form1")) {
	...
	GetSQLValueString ( $_POST ['tk_display_name'], "text" ), GetSQLValueString ( $_POST ['tk_user_rank'], "text" ), GetSQLValueString ( $_POST ['ID'], "int" ) );
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1"
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="25%" class="input_task_right_bg" valign="top"><table
					width="90%" border="0" cellspacing="0" cellpadding="0"
					align="center">
					<tr>
						<td valign="top" class="gray2">
							<h4 style="margin-top: 40px">
								<strong><?php echo $multilingual_user_tiptitle; ?></strong>
							</h4>
							<p>
	 <?php echo $multilingual_user_tiptext; ?></p>
			...
			<td width="75%" valign="top"><table width="98%" border="0"
				...
				<?php echo $row_Recordset1['tk_user_login']; ?>
							...
							<div class="form-group col-xs-12">
								...
								<div>
									<a data-toggle="modal"
										href="user_edit_password.php?UID=<?php echo $colname_Recordset1; ?>"
										data-target="#myModal"><?php echo $multilingual_user_edit_password; ?></a>
								</div>
							</div>
							...
							<div class="form-group col-xs-12">
								<label for="tk_display_name"><?php echo $multilingual_user_name; ?><span
									id="display_name" class="red">*</span></label>
								<div>
									<input type="text" name="tk_display_name" id="tk_display_name"
										value="<?php echo $row_Recordset1['tk_display_name']; ?>"
										placeholder="<?php echo $multilingual_user_name;?>"
										class="form-control" />
								</div>
        ...
        <?php }?>
							...
							<div class="form-group col-xs-12">
								...
								<div>
									...
									<input type="text" name="tk_user_contact" id="tk_user_contact"
										value="<?php echo $row_Recordset1['tk_user_contact']; ?>"
										placeholder="<?php echo $multilingual_user_contact;?>"
										class="form-control" />
							...
							<div class="form-group col-xs-12">
								...
								<div>
									<input type="text" name="tk_user_email" id="tk_user_email"
										value="<?php echo $row_Recordset1['tk_user_email']; ?>"
										placeholder="<?php echo $multilingual_user_email;?>"
										class="form-control" />
								</div>
							...
							<div class="form-group col-xs-12">
								...
								<div>
									<textarea name="tk_user_remark" id="tk_user_remark"
										class="form-control" rows="5"
										placeholder="<?php echo $multilingual_user_remark;?>"><?php echo $row_Recordset1['tk_user_remark']; ?></textarea>
								</div>
...
<?php if ($_SESSION['MM_rank'] > "4") { ?>
			  <div class="form-group col-xs-12">
								...
								<div>
									<select name="tk_user_rank" id="tk_user_rank"
										class="form-control">
										<option value="0"
											<?php if (!(strcmp("0", htmlentities($row_Recordset1['tk_user_rank'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $multilingual_dd_role_disabled; ?></option>
										<option value="1"
											<?php if (!(strcmp("1", htmlentities($row_Recordset1['tk_user_rank'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $multilingual_dd_role_readonly; ?></option>
										<option value="2"
											<?php if (!(strcmp("2", htmlentities($row_Recordset1['tk_user_rank'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $multilingual_dd_role_guest; ?></option>
										<option value="3"
											<?php if (!(strcmp("3", htmlentities($row_Recordset1['tk_user_rank'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $multilingual_dd_role_general; ?></option>
										<option value="4"
											<?php if (!(strcmp("4", htmlentities($row_Recordset1['tk_user_rank'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $multilingual_dd_role_pm; ?></option>
										<option value="5"
											<?php if (!(strcmp("5", htmlentities($row_Recordset1['tk_user_rank'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $multilingual_dd_role_admin; ?></option>
									</select>
...
<?php } else { ?>
          <input name="tk_user_rank" type="hidden"
							value="<?php echo $row_Recordset1['tk_user_rank'];?>" />
		...
		<tr class="input_task_bottom_bg">
			<td></td>
			<td height="50px">
				<button type="submit" class="btn btn-primary btn-sm submitbutton"
					name="cont"><?php echo $multilingual_global_action_save; ?></button>
				<button type="button" class="btn btn-default btn-sm"
					onclick="javascript:history.go(-1)"><?php echo $multilingual_global_action_cancel; ?></button>

				<input type="hidden" name="MM_update" value="form1" /> <input
				type="hidden" name="ID"
				value="<?php echo $row_Recordset1['uid']; ?>" />
			</td>
		</tr>
	</table>
