  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="logAddModalLabel">填写项目日志</h4>
      </div>
        ...
        <form>
          <!--选择日志填写时间-->
              <div class="form-group ">
                <label for="datepicker">选择填写日期<span id="datepicker_msg"></span></label>
                <div>
                  <span style="position: relative; z-index: auto;">
                  <input type="text" name="log_date" id="log_datetimepicker_md" value="<?php echo date('Y-m-d'); ?>" class="form-control"  />
                  </span>
                </div>
             </div>
              ...
              <div class="form-group">
                      <label for="dtp_input1" class="col-md-2 control-label">DateTime Picking</label>
                      <span style="position: relative; z-index: auto;">  
                        <div class="input-group date form_datetime_md col-md-5" data-date="1979-09-16T05:25:07Z" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
                            <input class="form-control" size="16" type="text" value="" readonly>
                            <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                            <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                        </div>
...
<script type="text/javascript">
    $('.form_datetime_md').datetimepicker();

     $('#log_datetimepicker_md').datetimepicker();
