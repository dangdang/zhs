...
(function (z, k) {
    ...
    if (!z.KindEditor) {
        ...
        var Ca = "4.1.1 (2012-06-10)", p = navigator.userAgent.toLowerCase(), o = p.indexOf("msie") > -1 && p.indexOf("opera") == -1, ka = p.indexOf("gecko") > -1 && p.indexOf("khtml") == -1, ba = p.indexOf("applewebkit") > -1, La = p.indexOf("opera") > -1, cc = p.indexOf("mobile") > -1, dc = /ipad|iphone|ipod/.test(p), S = document.compatMode != "CSS1Compat", B = (p = /(?:msie|firefox|webkit|opera)[\/:\s](\d+)/.exec(p)) ?
                p[1] : "0", Ba = (new Date).getTime(), O = Math.round, f = {
                DEBUG: !1,
                VERSION: Ca,
                IE: o,
                GECKO: ka,
        ...
        F(za, P, {
            init: function (a) {
                ...
                (e || g || h) && m.append(k);
                n([{btn: e, name: "preview"}, {btn: g, name: "yes"}, {btn: h, name: "no"}], function () {
                    if (this.btn) {
                ...
                this.mask = null;
                if (j)d = I(this.doc), this.mask = Ua({
                    x: 0,
                    y: 0,
                    z: this.z - 1,
                    cls: "ke-dialog-mask",
        ...
        la.prototype = {
            lang: function (a) {
                ...
                }), n = t(g) - i.div.height(), p = c.edit = zb({
                    height: n > 0 && t(g) > c.minHeight ? n : c.minHeight,
                    src: j,
                ...
                d ? (f(z).bind("resize", function () {
                    ...
                    moveEl: h, clickEl: m, moveFn: function (a,
                                                             c, d, e, g, f) {
                        e += f;
                        b(null, e)
                    }
                }) : m.first().css("visibility", "hidden"), c.resizeType === 2 ? Sa({
                    moveEl: h,
                    clickEl: m.last(),
